...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.discoveryTitle": "上游模型",
    "models.discoveryDescription": "获取 Provider 的模型列表，然后选择要添加的模型。",
    "models.discoveryFetching": "正在获取…",
    "models.discoveryFetch": "获取模型",
    "models.discoveryFilterPlaceholder": "筛选 {count} 个模型…",
    "models.discoveryFilter": "筛选上游模型",
    "models.discoverySelectShown": "选择当前结果",
    "models.discoveryClear": "清除",
    ...
    "models.catalogSearchPlaceholder": "搜索模型 ID 或名称",
    "models.catalogSearchLabel": "搜索 models.dev 定价",
    "models.catalogSearching": "正在搜索…",
    "models.catalogFindPrice": "查找价格",
    "models.catalogNoMatches": "没有匹配的定价预设。",
    "models.catalogPresetLabel": "models.dev 定价预设",
    "models.catalogOption": "{provider} · {name} · 输入 ${input} / 输出 ${output}",
    "models.catalogApply": "应用",
    "models.catalogApplyHint": "应用预设后会填充下方字段；所有值仍可手动编辑。",
