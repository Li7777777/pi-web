...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "models.discoveryTitle": "Upstream models",
    "models.discoveryDescription": "Fetch the provider model list, then select the models to add.",
    "models.discoveryFetching": "Fetching…",
    "models.discoveryFetch": "Fetch models",
    ...
    "models.catalogSearchPlaceholder": "Search model ID or name",
    "models.catalogSearchLabel": "Search models.dev pricing",
    "models.catalogSearching": "Searching…",
    "models.catalogFindPrice": "Find price",
    "models.catalogNoMatches": "No pricing presets matched this search.",
    "models.catalogPresetLabel": "models.dev pricing preset",
    "models.catalogOption": "{provider} · {name} · in ${input} / out ${output}",
    "models.catalogApply": "Apply",
    "models.catalogApplyHint": "Applying a preset fills the fields below; every value remains editable.",
